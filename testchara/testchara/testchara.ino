...
const int rs = 7, en = 5, d4 = 11, d5 = 10, d6 = 9, d7 = 8;
...
const byte ascii[][8] = 
{
  ...
  {0x0F, 0x02, 0x02, 0x02, 0x02, 0x12, 0x0C, 0x00}, //J    
  ...
  {0x00, 0x10, 0x08, 0x04, 0x02, 0x01, 0x00, 0x00}, //forward slash   
  ...
  {0x00, 0x00, 0x0E, 0x10, 0x10, 0x10, 0x0E, 0x00}, //c
  {0x01, 0x01, 0x0D, 0x13, 0x11, 0x11, 0x0F, 0x00}, //d
  {0x00, 0x00, 0x0E, 0x11, 0x1F, 0x10, 0x0E, 0x00}, //e
  {0x06, 0x08, 0x08, 0x1C, 0x08, 0x08, 0x08, 0x00}, //f
...
void setup() {
  ...
  lcd.begin(16, 2);
  pinMode(BACKLIGHT_PIN, OUTPUT); // pin to turn on or off backlight on lcd
  digitalWrite(BACKLIGHT_PIN, LOW);

  for(int i = 0; i < 8; i++)
  {
    lcd.createChar(i, ascii[i + 117]);
    lcd.setCursor(i, 0);
    lcd.write(i);
  }
}
